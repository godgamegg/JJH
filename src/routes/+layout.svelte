<script>
  import Nested1 from "./login/Nested.svelte";
  ...
  <div class="menu_2">
    ...
    <div class="search_box">
      <div class="search_1 search">
        ...
        <div class="search_button"><img src="/search_button.png" alt="" /></div>
      </div>
  ...
  <div style="overflow-y: auto;" class="communitylist">
    ...
    <div class="communityfolder">
      ...
      >
        ...
        <a href="/com_school"><div class="communitysite">선생님의 공지</div></a>
        <a href="/com_school"><div class="communitysite">자유게시판</div></a>
    ...
    <div class="communityfolder">
      ...
      >
        ...
        <a href="/com_school"><div class="communitysite">담임쌤의 공지</div></a>
        <a href="/com_school"><div class="communitysite">자유게시판</div></a>
